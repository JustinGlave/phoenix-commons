...
| **8a** | ValveMasterTool | `phase-8a-valvemaster-retrofit` | Not started — System B → A visible-theme swap. Operator-gated; doctrinal cooldown floor 2026-06-02 (14 days after Phase 3B's 2026-05-19 merge). |
